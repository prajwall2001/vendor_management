...
<body>
    ...
    <img src="https://redcloveradvisors.com/wp-content/uploads/2020/08/vendor-management-guide-1030x688.jpeg"
        alt="vm" class="center">
    <h4 style="color:purple">A vendor management project using Java and Spring is a web application designed to
        streamline the process of managing vendor relationships within an organization. It includes features such as
        storing vendor details, tracking contracts, evaluating performance, facilitating communication, and generating
        reports.</h4>
